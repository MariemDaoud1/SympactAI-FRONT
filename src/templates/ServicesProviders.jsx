...
import { Star, MapPin, Phone, Mail, Globe, Calendar, CheckCircle, Clock, DollarSign, Award, Filter, Search } from "lucide-react";
  ...
  const serviceProviders = [
    {
      ...
      description: "Leading pump maintenance specialists with over 20 years of experience in industrial pump systems.",
    ...
    },
    {
      ...
      description: "Specialized in complex pump installations and system optimization for maximum efficiency.",
    ...
    },
    {
      ...
      description: "Comprehensive parts supplier with extensive inventory and fast delivery nationwide.",
    ...
    },
    {
      ...
      services: ["Emergency Repair", "24/7 Support", "Critical Failure Recovery"],
      responseTime: "30 minutes",
      availability: "24/7/365",
      price: "$300/hour",
      certification: "Emergency Response Certified",
      description: "Rapid response team for critical pump failures and emergency situations.",
      image: "https://via.placeholder.com/100x100/ef4444/ffffff?text=EPR"
    }
  ];

  const categories = ["All", "Maintenance", "Installation", "Parts & Supply", "Emergency"];
    ...
    <div className="flex h-screen font-sans bg-gray-100">
      ...
      <main className="flex-1 bg-white overflow-y-auto px-8 py-4">
        ...
        <div className="flex justify-between items-center mt-4 mb-6">
          <h2 className="text-2xl font-bold text-[#1e3a8a]">Our Service Providers</h2>
          <div className="flex items-center gap-3">
            <span className="text-sm text-gray-500">{filteredProviders.length} providers available</span>
          </div>
        </div>
...
function StatCard({ title, value, desc, color, icon }) {
  return (
    <div className={`p-4 rounded-xl text-white shadow-md ${color} hover:shadow-lg transition-all duration-200 hover:scale-105`}>
...
function ProviderCard({ provider, onSelect, isSelected }) {
  return (
    <div className={`bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-200 cursor-pointer border-2 ${
      isSelected ? 'border-[#2563eb] shadow-lg' : 'border-transparent hover:border-gray-200'
    }`} onClick={onSelect}>
      <div className="p-6">
        {/* Header */}
        <div className="flex items-start gap-4 mb-4">
          ...
          <div className="text-right">
            <div className="text-sm font-semibold text-[#2563eb]">{provider.price}</div>
        ...
        <div className="grid grid-cols-3 gap-4 mb-4">
          <div className="text-center p-2 bg-green-50 rounded-lg">
            ...
            <div className="text-xs text-green-600">{provider.responseTime}</div>
          </div>
          <div className="text-center p-2 bg-blue-50 rounded-lg">
            <Calendar className="text-blue-600 mx-auto mb-1" size={16} />
            <div className="text-xs font-medium text-blue-700">Availability</div>
          ...
          <div className="text-center p-2 bg-purple-50 rounded-lg">
            ...
            <div className="text-xs text-purple-600">{provider.certification}</div>
          </div>
        </div>
