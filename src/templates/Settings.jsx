...
import { User, Bell, Shield, Palette, Database, Globe, Save, RotateCcw, Eye, EyeOff, Lock, Mail, Phone } from "lucide-react";
  ...
  return (
    <div className="flex h-screen font-sans bg-gray-100">
      ...
      <main className="flex-1 bg-white overflow-y-auto px-8 py-4">
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-gradient-to-r from-blue-100 to-blue-200 p-4 rounded-xl">
                <h4 className="font-semibold text-[#1e3a8a] mb-2">Data Retention</h4>
                <p className="text-sm text-gray-600 mb-3">How long to keep pump data</p>
                <select
              ...
              <div className="bg-gradient-to-r from-purple-100 to-purple-200 p-4 rounded-xl">
                <h4 className="font-semibold text-[#1e3a8a] mb-2">Export Data</h4>
                <p className="text-sm text-gray-600 mb-3">Download your pump data</p>
              ...
              <div className="bg-gradient-to-r from-indigo-100 to-indigo-200 p-4 rounded-xl">
                <h4 className="font-semibold text-[#1e3a8a] mb-2">Backup Settings</h4>
                <p className="text-sm text-gray-600 mb-3">Automatic data backup</p>
        ...
        {/* Quick Actions */}
        <div className="mt-8">
          <h3 className="text-lg font-semibold text-[#1e3a8a] mb-4">Quick Actions</h3>
...
function SettingsSection({ title, icon, children, fullWidth = false }) {
  return (
    <div className={`bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow p-6 ${fullWidth ? 'col-span-full' : ''}`}>
...
function QuickActionCard({ title, desc, color, icon }) {
  return (
    <button className={`${color} p-4 rounded-xl text-white shadow-sm hover:shadow-md transition-all duration-200 hover:scale-105 cursor-pointer text-left`}>
